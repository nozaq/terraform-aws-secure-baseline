...
output "config_configuration_recorder" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.config_baseline_ca-west-1[*].configuration_recorder)
...
output "config_sns_topic" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.config_baseline_ca-west-1[*].config_sns_topic)
...
output "guardduty_detector" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.guardduty_baseline_ca-west-1[*].guardduty_detector)
...
output "vpc_flow_logs_group" {
  ...
  value = local.flow_logs_to_cw_logs ? {
    ...
    "ca-west-1"      = one(module.vpc_baseline_ca-west-1[*].vpc_flow_logs_group)
...
output "default_vpc" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.vpc_baseline_ca-west-1[*].default_vpc)
...
output "default_security_group" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.vpc_baseline_ca-west-1[*].default_security_group)
...
output "default_network_acl" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.vpc_baseline_ca-west-1[*].default_network_acl)
...
output "default_route_table" {
  ...
  value = {
    ...
    "ca-west-1"      = one(module.vpc_baseline_ca-west-1[*].default_route_table)
